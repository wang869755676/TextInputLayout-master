...
public final class Alerter {
    ...
    public Alerter setTitleColor(final int colorRes) {
        if (getAlert() != null) {
            getAlert().setTitleColor(colorRes);
        }

        return this;
    }

    public Alerter setTitleSize(final int size) {
        if (getAlert() != null) {
            getAlert().setTitleSize(size);
        }
        return this;
    }

    public Alerter setTitleCenter() {
        if (getAlert() != null) {
            getAlert().setTitleCenter();
        }
        return this;
    }
    /**
